...
%     matched_pt1 = pt1(match(:,1),:);    % M,2
%     matched_pt2 = pt2(match(:,2),:);    % M,2
%     matched_pt1_padding = H*padarray(matched_pt1', [1,0],1,'post'); % 3,M
%     transformed_pt1 = matched_pt1_padding(1:2,:)';
%     dists = sqrt(sum((transformed_pt1-matched_pt2).^2,2));     % M,
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                              %
%                                 END YOUR CODE                                %
%                                                                              %
